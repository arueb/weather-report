...
//  }
// ]
const apiKey = "96b5bde5ac6a95ca19f97d60f4330e22";
  ...
  return (
    <div className="d-flex range-group">
      <div className="range-label">
        <label for="customRange2" class="form-label">{label}</label>
      </div>
...
const Footer = () => {
  ...
  <div class="container-sm">
    <span class="text-muted">Created by Alex Rueb</span>
  </div>
</footer>
  )
}

const isWeatherAlert = (forecast, minHighTemp, minLowTemp, maxTemp, daysBefore, daysAfter)=>{
...
class App extends React.Component {
    ...
    render() {
      const { dealers, isLoaded, forecasts, filter, minHighTemp, minLowTemp, maxTemp, daysBefore, daysAfter, showAlertsOnly, showIntlDealers, isLoading, expandSettings } = this.state;
